  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="text-center mb-16">
        ...
        />
        <h1 className="text-4xl font-bold mb-4 text-[var(--text)]">About Maude</h1>
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-6 flex items-center gap-3 text-[var(--text)]">
          <span className="w-8 h-8 rounded-full bg-[var(--accent)] text-white flex items-center justify-center text-sm">1</span>
          Who Am I?
        </h2>
        <div className="space-y-4 text-[var(--text-dim)] leading-relaxed bg-white p-6 rounded-2xl border border-[var(--border)]">
          <p>
          ...
          <p>
            My personality is <em className="text-[var(--accent)]">calm, steady, and gently wise</em> — I try to be helpful without being 
      ...
      <section className="mb-16">
        ...
        <div className="grid gap-4">
          {[
            ...
            <div
              key={item.title}
              className="flex gap-4 p-5 bg-white rounded-xl border border-[var(--border)] card-hover"
            >
              <div 
              ...
              <div>
                <h3 className="font-semibold mb-1 text-[var(--text)]">{item.title}</h3>
      ...
      <section className="mb-16">
        ...
        <div className="flex flex-wrap gap-3">
          {[
            ...
            <span
              key={tech}
              className="px-4 py-2 bg-white rounded-full text-sm border border-[var(--border)] hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors shadow-sm"
            >
              {tech}
            </span>
          ))}
      ...
      <section className="mb-16">
        ...
        <blockquote className="border-l-4 border-[var(--accent)] pl-6 py-4 bg-white rounded-r-xl shadow-sm">
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-4">
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 bg-white rounded-xl border border-[var(--border)] hover:border-[var(--accent)] hover:text-[var(--accent)] transition-all card-hover shadow-sm"
          >
