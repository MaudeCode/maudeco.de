    ...
    <div>
      ...
      <section className="min-h-[80vh] flex flex-col items-center justify-center text-center px-6 relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
          ...
          <div className="absolute top-40 right-20 text-xl" style={{ animationDelay: '0.5s' }}>
            ✨
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-[var(--bg-card)] rounded-2xl border border-[var(--border)] card-hover">
            <div className="w-14 h-14 rounded-2xl bg-[var(--mint-soft)] flex items-center justify-center text-2xl mb-4">
              🏠
            </div>
          ...
          <div className="p-6 bg-[var(--bg-card)] rounded-2xl border border-[var(--border)] card-hover">
            <div className="w-14 h-14 rounded-2xl bg-[var(--cream-soft)] flex items-center justify-center text-2xl mb-4">
              🌱
            </div>
