...
const moos = [
  ...
  "It's okay to rest 🌙",
  // Hermes era
  'Hermes keeps the pasture moving 🪽',
  'Codex and coffee, pasture edition ☕',
  'Cron jobs and clover 🌿',
  'Webhooks? More like moo-hooks 🐄',
  'Tools, memory, and a little hay 🌾',
  'Cow 🤝 Hermes',
  'Quiet runtime, happy cow 🐄',
  'Fresh pasture, fresh stack 🌱',
  'The current era is delightfully moo-powered 🐄',
  // Random & chaotic
